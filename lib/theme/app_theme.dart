...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData.light().copyWith(
    ...
    appBarTheme: const AppBarTheme(
      ...
      titleTextStyle:
          TextStyle(color: AppColorsLightTheme.darkBlue, fontSize: 28),
    ),
    ...
    listTileTheme: ListTileThemeData(
      ...
      contentPadding:
          const EdgeInsets.all(2), // Relleno del contenido del ListTile
      dense: true, // Establece el ListTile como denso
      shape: RoundedRectangleBorder(
        borderRadius:
            BorderRadius.circular(10), // Borde redondeado del ListTile
      ),
    ),
    cardTheme: CardTheme(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
        style: ButtonStyle(
      backgroundColor:
          MaterialStateProperty.all<Color>(AppColorsLightTheme.white),
    ...
    popupMenuTheme: PopupMenuThemeData(
        ...
        textStyle: const TextStyle(
          color: AppColorsLightTheme.darkBlue,
          fontSize: 18,
        )),
    ...
    dividerTheme: const DividerThemeData(
        thickness: 2,
        color: AppColorsLightTheme.grey,
        indent: 15,
        endIndent: 15),
